...
#' each survey location. High sediment mobility (\u03b8 >> \u03b8_cr) indicates that
...
#'   - `shields_parameter`: Shields number \u03b8 at each site
#'   - `shields_critical`: critical Shields number \u03b8_cr for the substrate d50
#'   - `mobility_ratio`: \u03b8 / \u03b8_cr (> 1.0 = mobile; < 1.0 = stable)
