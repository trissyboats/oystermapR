...
#' sources (Gaussian decay kernel, \u03c3 = dispersal_km / 2).
#'
...
#'   (default 5 km/day \u2248 mean current 0.06 m/s \u00d7 24 h). Increase for highly
...
#'   degrees for linking matrix entries to result rows (default 0.10 \u2248 10 km).
...
#'   (default 0.05 \u2248 5 km at mid-latitudes).
...
#'   (default 0.005 = 0.5\%). Filters very weak connections.
